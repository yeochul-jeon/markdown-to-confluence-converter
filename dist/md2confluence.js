...
var require_marked = __commonJS({
  "node_modules/marked/lib/marked.cjs"(exports2, module2) {
    "use strict";
...
var require_converter = __commonJS({
  "js/converter.js"(exports2, module2) {
    (function(root, factory) {
      if (typeof module2 === "object" && module2.exports) {
        const { marked } = require_marked();
        module2.exports = factory(marked);
      } else {
        root.ConfluenceConverter = factory(root.marked);
      }
    })(typeof globalThis !== "undefined" ? globalThis : exports2, function(marked) {
      "use strict";
      ...
      function convert(markdown, options2 = {}) {
...
`;
          ...
          code({ text, lang }) {
            ...
            if (lang) params.push(`language=${isMermaid ? "text" : lang}`);
            if (isMermaid) {
              params.push("title=mermaid");
              params.push("collapse=true");
            }
...
`;
          ...
          listitem(item) {
            ...
            if (item.task) {
              let result2 = `${prefix} ${text}
`;
              for (const sub of subListTokens) {
                result2 += this.list(sub);
              }
              return result2;
            }
          ...
          table(token) {
            ...
            if (token.header && token.header.length > 0) {
              const headerCells = token.header.map(
                (cell) => this.parser.parseInline(cell.tokens)
              ).join(" || ");
              result += `|| ${headerCells} ||
`;
            }
...
`;
      ...
      function postProcess(text) {
        ...
        processed = processed.replace(/\*\*(.+?)\*\*/g, "*$1*").replace(/\n{3,}/g, "\n\n");
        processed = processed.replace(/\x00CODE_BLOCK_(\d+)\x00/g, (_, idx) => {
          return codeBlocks[parseInt(idx)];
        });
        processed = processed.replace(/\x00CS\x00/g, "{{").replace(/\x00CE\x00/g, "}}");
...
var ConfluenceConverter = require_converter();
var options = {
